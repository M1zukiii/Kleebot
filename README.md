...
5. Spotify track/album/playlist links use public Spotify page metadata by default. Optional: set `SPOTIFY_USE_API=true`, `SPOTIFY_CLIENT_ID`, and `SPOTIFY_CLIENT_SECRET` only if you want Spotify API fallback.
6. Start the bot:
